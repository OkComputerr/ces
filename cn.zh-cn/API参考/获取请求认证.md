# 获取请求认证<a name="ZH-CN_TOPIC_0130260284"></a>
...
4.  对请求进行签名。
    ...
    1.  编辑“Demo.java”文件中的main方法，将以下内容替换为实际获取到的值。
        ...
        URL中project\_id获取请参见[获取项目ID](获取项目ID.md#ZH-CN_TOPIC_0130260285)，Endpoint请参见[地区和终端节点](http://developer.huaweicloud.com/endpoint)。

...
<td class="cellrowborder" valign="top" width="27%" headers="mcps1.1.7.1.6 "><p id="p849133211155"><a name="p849133211155"></a><a name="p849133211155"></a>测量对象：云服务器</p>
...
<td class="cellrowborder" valign="top" width="27%" headers="mcps1.1.7.1.6 "><p id="zh-cn_topic_0083516942_p178715519183"><a name="zh-cn_topic_0083516942_p178715519183"></a><a name="zh-cn_topic_0083516942_p178715519183"></a>测量对象：云服务器</p>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="p1089643391712"><a name="p1089643391712"></a><a name="p1089643391712"></a>该指标用于统计指定时间段内，平均每个写IO操作传输的字节数。</p>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="p6459153681719"><a name="p6459153681719"></a><a name="p6459153681719"></a>该指标用于统计指定时间段内，平均每个读IO操作传输的字节数。</p>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.2 "><p id="p13832031101713"><a name="p13832031101713"></a><a name="p13832031101713"></a>（Agent）平均IO服务时长</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="p15838318178"><a name="p15838318178"></a><a name="p15838318178"></a>该指标用于统计指定时间段内，平均每个读或写IO的操作时长。</p>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.5 "><p id="p861492124010"><a name="p861492124010"></a><a name="p861492124010"></a>测量对象：云服务器</p>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.4 "><p id="p761943410503"><a name="p761943410503"></a><a name="p761943410503"></a>≥0 ms/count</p>
</td>
...
<td class="cellrowborder" valign="top" width="8%" headers="mcps1.1.7.1.4 "><p id="p134873337381"><a name="p134873337381"></a><a name="p134873337381"></a>0,1</p>
</td>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="zh-cn_topic_0083516942_p216474618302"><a name="zh-cn_topic_0083516942_p216474618302"></a><a name="zh-cn_topic_0083516942_p216474618302"></a>该指标用于统计测量对象网卡每秒接收并已丢弃的数据包数量占所接收的数据包的比率。</p>
...
<td class="cellrowborder" valign="top" width="8%" headers="mcps1.1.7.1.4 "><p id="p1587223722"><a name="p1587223722"></a><a name="p1587223722"></a>0-100%</p>
</td>
...
<td class="cellrowborder" valign="top" width="27%" headers="mcps1.1.7.1.6 "><p id="p360454972810"><a name="p360454972810"></a><a name="p360454972810"></a>测量对象：云服务器</p>
...
<tr id="row8107444194710"><td class="cellrowborder" valign="top" width="10%" headers="mcps1.1.7.1.1 "><p id="p16108144124710"><a name="p16108144124710"></a><a name="p16108144124710"></a>proc_pHashId_file</p>
</td>
<td class="cellrowborder" valign="top" width="9%" headers="mcps1.1.7.1.2 "><p id="p135156347514"><a name="p135156347514"></a><a name="p135156347514"></a>进程打开文件数</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.7.1.3 "><p id="p6494154211513"><a name="p6494154211513"></a><a name="p6494154211513"></a>进程打开文件数，pHashId是进程名和进程ID的hashID。</p>
</td>
<td class="cellrowborder" valign="top" width="8%" headers="mcps1.1.7.1.4 "><p id="p1495523229"><a name="p1495523229"></a><a name="p1495523229"></a>≥0</p>
</td>
<td class="cellrowborder" valign="top" width="26%" headers="mcps1.1.7.1.5 "><p id="p77868151725"><a name="p77868151725"></a><a name="p77868151725"></a>测量对象：云服务器</p>
...
<td class="cellrowborder" rowspan="6" valign="top" width="27%" headers="mcps1.1.7.1.6 "><p id="p187261847105915"><a name="p187261847105915"></a><a name="p187261847105915"></a>暂不支持</p>
</td>
</tr>
<tr id="row4693634143510"><td class="cellrowborder" valign="top" headers="mcps1.1.7.1.1 "><p id="p106651442103712"><a name="p106651442103712"></a><a name="p106651442103712"></a>proc_running_count</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.2 "><p id="p6740185510386"><a name="p6740185510386"></a><a name="p6740185510386"></a>运行中进程数</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="p072111023915"><a name="p072111023915"></a><a name="p072111023915"></a>该指标用于统计测量对象处于运行状态的进程数</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.4 "><p id="p12928163310387"><a name="p12928163310387"></a><a name="p12928163310387"></a>≥ 0</p>
</td>
<td class="cellrowborder" rowspan="6" valign="top" headers="mcps1.1.7.1.5 "><p id="p8503193512179"><a name="p8503193512179"></a><a name="p8503193512179"></a>测量对象：云服务器</p>
...
<tr id="row1718113810351"><td class="cellrowborder" valign="top" headers="mcps1.1.7.1.1 "><p id="p106651042113715"><a name="p106651042113715"></a><a name="p106651042113715"></a>proc_idle_count</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.2 "><p id="p3740125514380"><a name="p3740125514380"></a><a name="p3740125514380"></a>空闲进程数</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="p872120113911"><a name="p872120113911"></a><a name="p872120113911"></a>该指标用于统计测量对象处于空闲状态的进程数</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.4 "><p id="p15939144053817"><a name="p15939144053817"></a><a name="p15939144053817"></a>≥ 0</p>
</td>
</tr>
<tr id="row55999406358"><td class="cellrowborder" valign="top" headers="mcps1.1.7.1.1 "><p id="p66651142143710"><a name="p66651142143710"></a><a name="p66651142143710"></a>proc_zombie_count</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.2 "><p id="p274010553387"><a name="p274010553387"></a><a name="p274010553387"></a>僵死进程数</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="p07216015392"><a name="p07216015392"></a><a name="p07216015392"></a>该指标用于统计测量对象处于僵死状态的进程数</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.4 "><p id="p17614113183818"><a name="p17614113183818"></a><a name="p17614113183818"></a>≥ 0</p>
</td>
</tr>
<tr id="row521644513353"><td class="cellrowborder" valign="top" headers="mcps1.1.7.1.1 "><p id="p116651042143719"><a name="p116651042143719"></a><a name="p116651042143719"></a>proc_blocked_count</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.2 "><p id="p2740755103817"><a name="p2740755103817"></a><a name="p2740755103817"></a>阻塞进程数</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="p1972120103917"><a name="p1972120103917"></a><a name="p1972120103917"></a>该指标用于统计测量对象被阻塞的进程数</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.4 "><p id="p137410434382"><a name="p137410434382"></a><a name="p137410434382"></a>≥ 0</p>
</td>
</tr>
<tr id="row26255483356"><td class="cellrowborder" valign="top" headers="mcps1.1.7.1.1 "><p id="p12666542163710"><a name="p12666542163710"></a><a name="p12666542163710"></a>proc_sleeping_count</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.2 "><p id="p1741105513811"><a name="p1741105513811"></a><a name="p1741105513811"></a>睡眠进程数</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="p17215017397"><a name="p17215017397"></a><a name="p17215017397"></a>该指标用于统计测量对象处于睡眠状态的进程数</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.4 "><p id="p16798174583811"><a name="p16798174583811"></a><a name="p16798174583811"></a>≥ 0</p>
</td>
</tr>
<tr id="row370513583356"><td class="cellrowborder" valign="top" headers="mcps1.1.7.1.1 "><p id="p18666134223719"><a name="p18666134223719"></a><a name="p18666134223719"></a>proc_total_coun</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.2 "><p id="p137416556389"><a name="p137416556389"></a><a name="p137416556389"></a>系统进程数</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="p157213019397"><a name="p157213019397"></a><a name="p157213019397"></a>该指标用于统计测量对象的总进程数。</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.4 "><p id="p19126829113811"><a name="p19126829113811"></a><a name="p19126829113811"></a>≥ 0</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.5 "><p id="p49411092349"><a name="p49411092349"></a><a name="p49411092349"></a>测量对象：云服务器</p>
...
<tr id="row12647104511358"><td class="cellrowborder" valign="top" width="10%" headers="mcps1.1.7.1.1 "><p id="p196481645143511"><a name="p196481645143511"></a><a name="p196481645143511"></a>slot0_gpu_performance_state</p>
</td>
<td class="cellrowborder" valign="top" width="9%" headers="mcps1.1.7.1.2 "><p id="p17121531516"><a name="p17121531516"></a><a name="p17121531516"></a>性能状态</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.7.1.3 "><p id="p57121353125118"><a name="p57121353125118"></a><a name="p57121353125118"></a>该指标用于统计测量对象当前的性能状态。该指标无单位。</p>
</td>
<td class="cellrowborder" valign="top" width="8%" headers="mcps1.1.7.1.4 "><p id="p107121653175115"><a name="p107121653175115"></a><a name="p107121653175115"></a>P0-P15、P32，P0表示最大性能状态，P15表示最小性能状态，P32表示状态未知。</p>
</td>
<td class="cellrowborder" valign="top" width="26%" headers="mcps1.1.7.1.5 "><p id="p176482045113513"><a name="p176482045113513"></a><a name="p176482045113513"></a>测量对象：云服务器</p>
...
<td class="cellrowborder" rowspan="3" valign="top" width="27%" headers="mcps1.1.7.1.6 "><p id="p1178978163919"><a name="p1178978163919"></a><a name="p1178978163919"></a>暂不支持</p>
</td>
</tr>
<tr id="row8411154816350"><td class="cellrowborder" valign="top" headers="mcps1.1.7.1.1 "><p id="p174115486353"><a name="p174115486353"></a><a name="p174115486353"></a>slot0_gpu_usage_mem</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.2 "><p id="p371205316513"><a name="p371205316513"></a><a name="p371205316513"></a>显存使用率</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="p1712453175111"><a name="p1712453175111"></a><a name="p1712453175111"></a>该指标用于统计测量对象当前的显存使用率，以百分比为单位。</p>
<p id="p492115741517"><a name="p492115741517"></a><a name="p492115741517"></a>单位：百分比</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.4 "><p id="p18712195314515"><a name="p18712195314515"></a><a name="p18712195314515"></a>0-100%</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.5 "><p id="p17411164833514"><a name="p17411164833514"></a><a name="p17411164833514"></a>测量对象：云服务器</p>
...
<tr id="row115738516357"><td class="cellrowborder" valign="top" headers="mcps1.1.7.1.1 "><p id="p6573051193518"><a name="p6573051193518"></a><a name="p6573051193518"></a>slot0_gpu_usage_gpu</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.2 "><p id="p171385315110"><a name="p171385315110"></a><a name="p171385315110"></a>GPU利用率</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="p1971315538511"><a name="p1971315538511"></a><a name="p1971315538511"></a>该指标用于统计测量对象当前的GPU利用率。</p>
<p id="p16984131014151"><a name="p16984131014151"></a><a name="p16984131014151"></a>单位：百分比</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.4 "><p id="p671325335120"><a name="p671325335120"></a><a name="p671325335120"></a>0-100%</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.5 "><p id="p757385112354"><a name="p757385112354"></a><a name="p757385112354"></a>测量对象：云服务器</p>

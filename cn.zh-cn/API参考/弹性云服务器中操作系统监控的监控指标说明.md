...
<td class="cellrowborder" valign="top" headers="mcps1.1.7.1.3 "><p id="p1089643391712"><a name="p1089643391712"></a><a name="p1089643391712"></a>该指标用于统计指定时间段内，平均每个写I/O操作传输的字节数。</p>
